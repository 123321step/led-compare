const TRANSLATIONS = {
  zh: {
    ...
    sourceScope: "当前前台展示的都是海外官网真实抓取产品: 海康威视、洲明、强力巨彩、艾比森、诺瓦、卡莱特。",
  ...
  en: {
    ...
    sourceScope: "The live catalog now shows only products crawled from official global sites: Hikvision, Unilumin, Qiangli LED, Absen, NovaStar, and Colorlight.",
    useCaseEyebrow: "Use Case",
