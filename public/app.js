const TRANSLATIONS = {
  zh: {
    ...
    sourceScope: "当前前台只展示海外官网真实抓取产品: 海康威视、洲明、强力巨彩、诺瓦、卡莱特。艾比森暂未接入海外官网目录，已从前台隐藏。",
  ...
  en: {
    ...
    sourceScope: "The live catalog currently shows only products crawled from official global sites: Hikvision, Unilumin, Qiangli LED, NovaStar, and Colorlight. Absen stays hidden until its overseas catalog is connected.",
    useCaseEyebrow: "Use Case",
